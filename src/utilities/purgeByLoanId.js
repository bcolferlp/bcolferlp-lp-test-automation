...
class PurgeLoansById {
    ...
    purgeLoans() {
        ...
        Promise.resolve(this.loanids)
            .each(id => {
                return new Promise(resolve => {
                    Promise.bind()
                        .then(() => { return this.deleteConsumerPaymentInfo(id) })
                        .then(() => { return this.deleteConsumerStips(id) })
                        .then(() => { return this.deleteContractReview(id) })
                        .then(() => { return this.deleteEmailSent(id) })
                        .then(() => { return this.deleteEvents(id) })
                        .then(() => { return this.deleteInternalStips(id) })
                        .then(() => { return this.deleteLoanNotes(id) })
                        .then(() => { return this.deleteScheduledEvents(id) })
                        .then(() => { this.deleteLoan(id) })
                        .then(resolve)
    ...
    deleteLoan(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-loans`
    ...
    deleteScheduledEvents(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-scheduled-events`
            this.docClient['query']({
                TableName: tableName,
                IndexName: 'GSI0',
    ...
    deleteLoanNotes(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-loan-notes`
            this.docClient['query']({
                TableName: tableName,
                KeyConditionExpression: 'loanid = :loanid',
                ExpressionAttributeValues: { ':loanid': loanId }
    ...
    deleteInternalStips(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-internal-stips`
            this.docClient['query']({
                TableName: tableName,
    ...
    deleteEvents(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-events`
            this.docClient['query']({
                TableName: tableName,
                IndexName: 'GSI0',
                KeyConditionExpression: 'loanId = :loanid',
    ...
    deleteEmailSent(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-email-sent`
            this.docClient['query']({
                TableName: tableName,
                IndexName: 'GSI0',
                KeyConditionExpression: 'loanid = :loanid',
    ...
    deleteContractReview(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-contract-review`
            this.docClient['query']({
                TableName: tableName,
                KeyConditionExpression: 'loanId = :loanId',
                ExpressionAttributeValues: { ':loanId': loanId }
    ...
    deleteConsumerStips(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-consumer-stips`
            this.docClient['query']({
                TableName: tableName,
    ...
    deleteConsumerPaymentInfo(loanId) {
        return new Promise((resolve, reject) => {
            let tableName = `${this.stage}-consumer-payment-info`
            this.docClient['delete']({
                TableName: tableName,
                Key: { loanId: loanId },
