        ...
        <tr style="padding:0;text-align:left;vertical-align:top">
          ...
          >
            <center data-parsed="" style="width:100%">
              <div class="header text-center" align="center" style="background:#191919;color:#fff;font-size:18px;font-weight:500">
                <table
                  class="container"
                        ...
                        >
                          <tbody>
                            <tr style="padding:0;text-align:left;vertical-align:top">
                              ...
                              >
                                <table
                                  style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%;margin-left:20px;"
                                >
                                  <tbody>
                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                      <th
                                      ...
                                      >
                                        <img
                                          src="https://s3-us-west-2.amazonaws.com/loanpal-emails/loanpal-white.png"
                                          alt="LoanPal"
                              ...
                              <th
                                class="small-8 large-8 columns last"
                                ...
                                <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                  <tbody>
                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                      ...
                                      >
                                        <p
                                          style="color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:19px;margin:0;margin-top:10px;margin-right:20px;padding:0;text-align:right;"
                                        >
                                          (844) 910-0111
                                        </p>
                                      </th>
                    ...
                    >
                      ...
                      >
                        <tbody>
                          <tr>
                            <th
                              class="small-12 large-1 columns first last"
                              ...
                              >
                                <tbody>
                                  <tr style="padding:0;text-align:left;vertical-align:top">
                                    ...
                                    >
                                      <p
                                        style="color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-weight:700;font-size:18px;line-height:25px;margin:0;margin-bottom:30px;margin-top:20px;padding:0;text-align:center"
                                      >
                                        <!--You've applied for a solar loan.-->You've applied for a solar loan.
                                      </p>
                                      <p>Congratulations, John!</p>
                                      <p>
                                        You have been approved for a Loanpal loan up to a maximum of $20,000 to purchase a solar system for your home under the
                                        following products:
                                      </p>
                                      <ul>
                                        <li>20 year 3.99% interest rate loan</li>
                                      </ul>
                                      <p>
                                        Please do not hesitate to call the Loanpal team with any questions about the terms of the loan agreement at
                                        <u>(844) 910-0111</u>.
                                      </p>
                                      <p>
                                        We look forward to funding your loan once the required documents are received and reviewed, final loan documents are
                                        signed, and your solar system is installed.
                                      </p>
                                      <p>
                                        We take pride in our ability to help our clients with their financing needs, and we are excited for you to become a part
                                        of our Loanpal family.
                                      </p>
                                      <p><b>Next Steps</b></p>
                                      <ol>
                                        <li>
                                          Get your loan docs by clicking the button below, once you receive them please review and sign.<br />
                                          <p><a href="secureLink" class="btn filled">Get loan docs</a></p>
                                        </li>
                                        <li>
                                          You can sign your loan docs now. However, prior to funding your loan, we’ll need to validate your identification.
                                          Please click the button below to upload your ID.
                                          <p><a href="@root.stipsSecureLink" class="btn bordered">Upload documentation</a></p>
                                        </li>
                                        <li>You should also expect a call from Loanpal to validate your identity.</li>
                                      </ol>
                                      <p>Reference Number: ABC-123456</p>
                                      <p>Application ID: 12-34-567890</p>
                                      <p></p>
                                      <p>Best Regards,</p>
                                      <p>The Loanpal Team</p>
                                      <p
                                    ...
                                    >
                                      ...
                                      >
                                        <span style="font-style:italic;"
                                          >Copyright <span style="width:10px !important;height:10px !important;">&copy;</span> 2017 LoanPal All rights
                                          reserved</span
                                        >
                                        <br />8781 Sierra College Blvd <br />Roseville, CA 95661 <br />
                                        <br />
                                        <br />You are receiving this email because you agreed to receive electronic communications from LoanPal <br />
                                        <br />Want to stop receiving these emails? <br />You can
                                        <a
                                          href="{{unsubscribeLink}}"
                                          style="Margin:0;color:#2199e8;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none;cursor:pointer;"
                                        ...
                                        <br /><strong
                                          ...
                                          |
                                          <a
                                            href="http://loanpal.com/privacy.html"
                                            style="Margin:0;color:#2199e8;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none"
                                            >Private Policy</a
                                          ></strong
                                        >
